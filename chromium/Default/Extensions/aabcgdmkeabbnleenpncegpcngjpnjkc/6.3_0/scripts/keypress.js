/*Copyright (c) 2022 ksoft http://www.dummysoftware.com*/var keyPressManager={tabId:null,lastSendMessageDate:null,onKeyPress:function(e){var o=10,a=new Date;3<(o=null!=keyPressManager.lastSendMessageDate?(a-keyPressManager.lastSendMessageDate)/1e3:o)&&(keyPressManager.lastSendMessageDate=a,e=e||window.event,chrome.runtime.sendMessage({tabId:keyPressManager.tabId,action:"resetInterval"}))},click:function(e){var o=null;try{var a,o=0==e.indexOf("document.")?(a=e.replace(/"/g,"'"),console.log("Auto command."),setTimeout(a,100),null):(console.log("Auto click: "+e),document.querySelector(e))}catch(e){}null!=o&&o.click()},playSound:function(e){var o=new Audio;return o.src=e,o.play()},play:function(o){var e=keyPressManager.playSound(o);void 0!==e&&e.then(e=>{console.log("Playing notification sound "+o)}).catch(e=>{console.warn(`Unable to play notification sound ${o}
