config.load_autoconfig('autoconfig.yml')
...
config.bind('<Shift-f>', 'hint links spawn --detach mpv --force-window=immediate yes {hint-url}')

##:bind xx config-cycle statusbar.hide ;; config-cycle tabs.show always switching
##:bind xt config-cycle tabs.show always switching
##:bind xb config-cycle statusbar.hide
...
c.url.searchengines = {
                       ...
                       'e'      : 'https://www.ebay.co.uk/sch/i.html?_from=R40&_trksid=p2380057.m570.l1313&_nkw={}&_sacat=0',
                       'et'     : 'https://etymonline.com/?search={}',
                       'y'     : 'www.youtube.com/results?search_query={}',
                       'r'      : 'https://reddit.com/search/?q={}',
                       'rr'     : 'https://reddit.com/search/?q={}&type=sr',
                       'rrr'    : 'https://reddit.com/search/?q={}&type=comment',
                       'rrrr'   : 'https://reddit.com/search/?q={}&type=user',
